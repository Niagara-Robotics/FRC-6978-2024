...
public class Constants {
    ...
    public static class Launcher {
        ...
        public static double maxWheelCurrent = 35;
        ...
        public static double trapTiltPosition = 1.23;
    ...
    public static class Intake {
        public static double floorRollerPower = 0.65;
    ...
    public static class Lift {
        public static double powerUp = 0.4;
        public static double powerDown = 0.2;
    ...
    public static class AutoPilot {
        public static double anglekP = 8.0;
        public static double angularVelocityLimit = 3.0; //radians per second
        public static double angularVelocityThreshold = 0.05;

        public static double distancekP = 3.5;
        public static double linearVelocityLimit = 1.5; //radians per second
        public static double deltaStopPoint = 0.6;

        public static double distanceThreshold = 0.08;
    }
